...
req=requests.get('https://timesprayer.com/en/prayer-times-in-kafr-al-sheikh.html',headers=headers)
...
test.title("PRAYER TIMES AT KAFR ASHYKH")
...
title=Label(test,text="مواقيت الصلاة فى كفر الشيخ",height=2,font=("ِArial",30),relief="raised",bd=10,fg='#E7EAEF',bg='#37745B').pack()
